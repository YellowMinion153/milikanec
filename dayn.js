...
bot.on('message', msg => {
    ...
    if(ignoreCase.equals(msg.content, 'g!help')){
        msg.channel.send('```Гуки на деревьях                                                               ' +
            ...
            'Напалм                                                                          ' +
            'g!heart                                                                         ' +
            'Пытать гука: Сломать палец; Устроить нехватку кислорода; Включить элджея; Снять с гука штаны; Пнуть гука; ' +
            'Поставить гука коленями на рис; Обзывать гука; Топить гука; Напоить гук                                                                     ' +
            'Даун гук                                                                          ' +
            'Гимн гуков```');
